...
import { EspecializacionComponent } from './demo/pages/especializaciones/especializacion.component';
import { HistoriasComponent } from './demo/pages/Historia_Clinica/historia_clinica.component';
export const routes: Routes = [
  ...
  },  
  {
    ...
    children: [      
       ...
       {path: 'historia_clinica', component: HistoriasComponent, data: { title: 'Historia Clinica' }}
